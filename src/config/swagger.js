			...
			schemas: {
				...
				User: {
					...
					Achievement: {
						type: 'object',
						properties: {
							type: { type: 'string', enum: ['certificate', 'badge', 'other'] },
							code: { type: 'string' },
							title: { type: 'string' },
							...
							meta: { type: 'object' },
							awardedBy: { oneOf: [{ type: 'string' }, { $ref: '#/components/schemas/User' }] },
				...
				ShopItem: {
					type: 'object',
					properties: {
						_id: { type: 'string', example: '65f12ca7a7720c194de6c001' },
						name: { type: 'string', example: 'Colorful Pens Set' },
						description: { type: 'string', example: 'Set of 12 colorful gel pens for drawing' },
						image: { type: 'string', example: '/uploads/shop/pen-set.jpg' },
						price: { type: 'number', example: 50 },
						stock: { oneOf: [{ type: 'number', example: 25 }, { type: 'null' }] },
						isActive: { type: 'boolean', example: true },
						category: { type: 'string', example: 'stationery' },
						createdBy: { type: 'string', example: '65f12ca7a7720c194de6a095' },
						createdAt: { type: 'string', format: 'date-time' },
						updatedAt: { type: 'string', format: 'date-time' },
					},
				},
				ShopItemCreateInput: {
					...
					properties: {
						...
						stock: { oneOf: [{ type: 'number', minimum: 0, example: 25 }, { type: 'null' }] },
						category: { type: 'string', example: 'stationery' },
					},
				},
				ShopItemUpdateInput: {
					type: 'object',
					properties: {
						name: { type: 'string', example: 'Premium Colorful Pens Set' },
						description: { type: 'string', example: 'Updated description' },
						image: { type: 'string', example: '/uploads/shop/premium-pen-set.jpg' },
						price: { type: 'number', minimum: 0, example: 75 },
						stock: { oneOf: [{ type: 'number', minimum: 0, example: 20 }, { type: 'null' }] },
						isActive: { type: 'boolean', example: true },
						category: { type: 'string', example: 'stationery' },
					},
				},
				Purchase: {
					type: 'object',
					properties: {
						_id: { type: 'string', example: '65f12ca7a7720c194de6c002' },
						student: {
							oneOf: [
								{ type: 'string', example: '65f12ca7a7720c194de6b002' },
								{ $ref: '#/components/schemas/Student' },
							],
						},
						item: {
							oneOf: [
								{ type: 'string', example: '65f12ca7a7720c194de6c001' },
								{ $ref: '#/components/schemas/ShopItem' },
							],
						},
						coinSpent: { type: 'number', example: 50 },
						status: {
							type: 'string',
						...
						deliveredBy: {
							oneOf: [
								{ type: 'string', example: '65f12ca7a7720c194de6a095' },
								{ $ref: '#/components/schemas/User' },
							],
						},
						...
						cancelReason: { type: 'string', example: 'Item out of stock' },
						createdAt: { type: 'string', format: 'date-time' },
						updatedAt: { type: 'string', format: 'date-time' },
					},
				},
				PurchaseBuyInput: {
					...
					required: ['itemId'],
					properties: {
						itemId: { type: 'string', example: '65f12ca7a7720c194de6c001' },
					},
				},
				PurchaseCancelInput: {
					type: 'object',
					...
					properties: {
						cancelReason: { type: 'string', example: 'Item no longer available' },
					},
				},
			},
		},
