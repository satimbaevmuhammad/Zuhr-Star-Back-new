...
/**
 * @swagger
 * /api/finance/students/{studentId}/discount:
 *   post:
 *     tags: [Finance]
 *     summary: Set or update a student's course discount (admin only)
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *     responses:
 *       200:
 *         description: Discount updated and financial event recorded
 *       400:
 *         description: Validation failed
 *       403:
 *         description: Forbidden
 */
router.post('/students/:studentId/discount', allowRoles('admin', 'superadmin'), validateObjectId('studentId'), financeController.setStudentDiscount)
